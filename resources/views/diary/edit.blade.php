                        ...
                        <div class="mt-4">
                            <form action="{{ route('diary.update', $diary->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <label style="font-family: 'Signika Negative', sans-serif;"
                                        class="font-weight-bold">GAMBAR</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="font-family: 'Varela Round', sans-serif;" type="text"
                                        class="form-control @error('title') is-invalid @enderror" name="title"
                                        value="{{ old('title', $diary->title) }}" placeholder="Masukkan Judul Post">
                                ...
                                <div class="form-group">
                                    <label style="font-family: 'Signika Negative', sans-serif;"
                                        class="font-weight-bold">KONTEN</label>
                                    <textarea style="font-family: 'Varela Round', sans-serif;" class="form-control @error('content') is-invalid @enderror"
                                        name="content" rows="5" placeholder="Masukkan Konten Post">{{ old('content', $diary->content) }}</textarea>
                                    ...
                                    <select style="font-family: 'Varela Round', sans-serif;" class="form-control"
                                        ...
                                        @foreach ($emojis as $emoji)
                                            <option value="{{ $emoji->id }}"
                                                {{ old('emoji', $diary->reaction ? $diary->reaction->id : '') == $emoji->id ? 'selected' : '' }}>
                                                {{ $emoji->emoji }}
                                            </option>
                                        @endforeach
                                    </select>
