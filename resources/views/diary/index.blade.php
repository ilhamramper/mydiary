...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h1 class="text-center mb-5" style="font-family: 'Caprasimo', cursive;">Diary Page</h1>
                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="{{ route('diary.create') }}" class="btn btn-primary"
                                    style="font-family: 'Varela Round', sans-serif;"><i
                                        class="fa-solid fa-square-plus fa-lg"></i> &nbsp;<strong>New Diary</strong></a>
                            </div>
                            <div class="col-md-6 text-right">
                                <!-- Tombol/link untuk menuju halaman Trash -->
                                <a href="{{ route('diary.trash') }}" class="btn btn-success"
                                    style="font-family: 'Varela Round', sans-serif;"><strong>Trash Page</strong>
                        ...
                        <ul class="list-group mt-4">
                            @foreach ($diaries as $diary)
                                <li class="list-group-item">
                                    <p>
                                        @if ($diary->image)
                                            <img src="{{ asset('storage/' . $diary->image) }}"
                                                alt="{{ $diary->title }}" class="diary-image"
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p class="font-italic text-muted"
                                            ...
                                            @if ($diary->created_at != $diary->updated_at)
                                                Diedit : {{ $diary->updated_at }}
                                            @else
                                                Ditambahkan : {{ $diary->created_at }}
                                            @endif
                                        </p>
                                        <div>
                                            @if ($diary->reaction)
                                    ...
                                    <div>
                                        <!-- Tombol/link untuk menuju halaman Edit -->
                                        <a href="{{ route('diary.edit', $diary->id) }}"><button type="button"
                                                class="btn btn-primary"><i
                                                    class="fa-solid fa-pen-to-square"></i></button></a>
                                        <!-- Form untuk menghapus diary -->
